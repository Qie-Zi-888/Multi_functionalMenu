...
#define QSPI_FLASH_D1_GPIO_CLK           CRM_GPIOC_PERIPH_CLOCK
#define QSPI_FLASH_D1_GPIO_PIN           GPIO_PINS_3
#define QSPI_FLASH_D1_GPIO_PINS_SOURCE   GPIO_PINS_SOURCE3
#define QSPI_FLASH_D1_GPIO_PORT          GPIOC
