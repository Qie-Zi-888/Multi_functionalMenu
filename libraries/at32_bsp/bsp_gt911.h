...
typedef enum
{
  ...
  TOUCH_SCAN_VERTICAL_180               = 0x02, /*!< vertical display */
  TOUCH_SCAN_HORIZONTAL_180             = 0x03  /*!< horizontal display */
} touch_scan_type;
...
#define GT_INT_READ()                    1 //gpio_input_data_bit_read(GT_INT_GPIO_PORT, GT_INT_GPIO_PIN)
