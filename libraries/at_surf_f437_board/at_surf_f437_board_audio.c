...
/**
  ...
  */
#define WM8988_REG_BITW16                ((WM8988_R7_AUDIO_INTERFACE << 9) | 0x0042)//0x0042
...
void codec_i2s_init(audio_codec_type *param)
{
  ...
  dmamux_init(DMA1MUX_CHANNEL4, DMAMUX_DMAREQ_ID_I2S2_EXT_RX);
...
void DMA1_Channel3_IRQHandler(void)
{
  ...
  {
    copy_buff(spk_dma_buffer, (uint16_t *)music_output_buffer, 2306);
